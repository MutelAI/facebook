...
@Component({
  ...
  template: `
    <section
      id="hero"
      [class]="'relative overflow-hidden bg-gradient-to-br linear-gradient(135deg, #1e3a8a 0%, #1e40af 50%, #0c4a6e 100%) flex items-center ' + (biz.design().hero_layout === 'minimal' ? 'min-h-[70vh] items-end' : 'justify-center min-h-screen')"
      [attr.dir]="i18n.dir()"
    >
      <!-- ═══ Background patterns ═══ -->
